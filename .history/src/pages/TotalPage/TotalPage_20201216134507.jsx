 ...
 * @LastEditTime: 2020-12-16 13:45:07
                        ...
                        <div className="total_body"> 
                            ...
                            <div className="cont_bottom">
                                ...
                                <div className="cont_bottom_right">
                                    <SectorMonitor className="airport_sector" title="西安01扇区" />
                                    <SectorMonitor className="airport_sector" title="西安02扇区" />
                                    <SectorMonitor className="airport_sector" title="西安03扇区" />
                                    <SectorMonitor className="airport_sector" title="西安04扇区" />
                                    <SectorMonitor className="airport_sector" title="西安05扇区" />
                                    <SectorMonitor className="airport_sector" title="西安06扇区" />
                                    <SectorMonitor className="airport_sector" title="西安07扇区" />
                                    <SectorMonitor className="airport_sector" title="西安08扇区" />
                                </div>
