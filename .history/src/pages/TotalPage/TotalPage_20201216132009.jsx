 ...
 * @LastEditTime: 2020-12-16 13:20:03
...
import AirportMonitor from '../../components/AirportMonitor/AirportMonitor'
import SecotorMonitor from '../../components/SecotorMonitor/SecotorMonitor'
                        ...
                        <div className="total_body"> 
                            ...
                            <div className="cont_bottom">
                                ...
                                <div className="cont_bottom_right">
                                    <SecotorMonitor className="airport_sector" title="西安01扇区" />
                                    <SecotorMonitor className="airport_sector" title="西安02扇区" />
                                </div>
