 ...
 * @LastEditTime: 2020-12-16 13:21:03
...
import MiniMonitor from './MiniMonitor/MiniMonitor'

function SecotorMonitor(props){
   const getOption = function(){
    ...
    return (
        <MiniMonitor option={getOption} />
    )
}

export default SecotorMonitor