 ...
 * @LastEditTime: 2020-12-15 18:25:31
            ...
            <div classNam="timeline_canvas">
                <div className="timeline date_line">
                {
                    timeNum.map( (item) => {
                        ...
                        return (
                            <div key={item} className="" style={{ height: (contentHeight/60).toFixed(2) }}>{str}</div>
                        )
                    })
                ...
                <div className="timeline line1">
                {
                    timeNum.map( (item) => {
                        return (
                            <div key={item} style={{width: '100px', backgroundColor: 'green', height: (contentHeight/60).toFixed(2)}}>航班{item}</div>
                        )
                    })
                ...
                <div className="timeline line2">
                {
                    timeNum.map( (item) => {
                        return (
                            <div key={item} style={{width: '100px', backgroundColor: 'green', height: (contentHeight/60)}}>航班{item}</div>
                        )
                    })
