 ...
 * @LastEditTime: 2020-12-15 19:52:58
            ...
            <div className="timeline_canvas">
                <div className="timeline date_line">
                {
                    timeNum.map( (item) => {
                        ...
                        return (
                            <div key={item} className="" style={`{ height: flightHeight, borderRight: '1px solid #fff', borderBottom: ${str} != "" ?'1px solid #fff': "none" } }`}>{str}</div>
                        )
                    })
