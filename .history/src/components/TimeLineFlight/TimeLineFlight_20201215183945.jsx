 ...
 * @LastEditTime: 2020-12-15 18:39:42
          ...
          onResize={({width, height}) => {
            ...
            <div classNam="timeline_canvas">
                ...
                <div className="timeline line1">
                {
                    timeNum.map( (item) => {
                        return (
                            <FlightCard key={item} height={flightHeight} >航班{item}</FlightCard>
                        )
                    })
                ...
                <div className="timeline line2">
                {
                    timeNum.map( (item) => {
                        return (
                            <FlightCard key={item} style={{width: '100px', backgroundColor: 'green', height: flightHeight}}>航班{item}</FlightCard>
                        )
                    })
